...
namespace Client {
    ...
    public partial class DBDataSet6 : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeeRow AddEmployeeRow(string FirstName, string MiddleName, string LastName, string SSN) {
...
namespace Client.DBDataSet6TableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([EmployeeId] = @Original_EmployeeId) AND ([S" +
                "SN] = @Original_SSN))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([FirstName], [MiddleName], [LastName], [SSN]) VALUE" +
                "S (@FirstName, @MiddleName, @LastName, @SSN);\r\nSELECT EmployeeId, FirstName, Mid" +
                "dleName, LastName, SSN FROM Employee WHERE (EmployeeId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [FirstName] = @FirstName, [MiddleName] = @MiddleName, [LastName] = @LastName, [SSN] = @SSN WHERE (([EmployeeId] = @Original_EmployeeId) AND ([SSN] = @Original_SSN));
SELECT EmployeeId, FirstName, MiddleName, LastName, SSN FROM Employee WHERE (EmployeeId = @EmployeeId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeId, FirstName, MiddleName, LastName, SSN FROM dbo.Employee";
        ...
        public virtual int Fill(DBDataSet6.EmployeeDataTable dataTable) {
        ...
        public virtual DBDataSet6.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DBDataSet6.EmployeeDataTable dataTable = new DBDataSet6.EmployeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DBDataSet6.EmployeeDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DBDataSet6 dataSet) {
        ...
        public virtual int Delete(int Original_EmployeeId, string Original_SSN) {
        ...
        public virtual int Insert(string FirstName, string MiddleName, string LastName, string SSN) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string MiddleName, string LastName, string SSN, int Original_EmployeeId, string Original_SSN, int EmployeeId) {
            if ((FirstName == null)) {
                throw new global::System.ArgumentNullException("FirstName");
            }
            else {
            ...
            if ((Original_SSN == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_SSN));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string MiddleName, string LastName, string SSN, int Original_EmployeeId, string Original_SSN) {
            return this.Update(FirstName, MiddleName, LastName, SSN, Original_EmployeeId, Original_SSN, Original_EmployeeId);
        }
    }
