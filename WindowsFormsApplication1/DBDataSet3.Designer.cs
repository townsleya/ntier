...
namespace Client {
    ...
    public partial class DBDataSet3 : global::System.Data.DataSet {
        ...
        public partial class SalaryDataTable : global::System.Data.TypedTableBase<SalaryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public SalaryRow AddSalaryRow(int EmployeeId, decimal Salary) {
...
namespace Client.DBDataSet3TableAdapters {
    ...
    public partial class SalaryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Salary] WHERE (([SalaryId] = @Original_SalaryId) AND ([Employe" +
                "eId] = @Original_EmployeeId) AND ([Salary] = @Original_Salary))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Salary] ([EmployeeId], [Salary]) VALUES (@EmployeeId, @Salary)" +
                ";\r\nSELECT SalaryId, EmployeeId, Salary FROM Salary WHERE (SalaryId = SCOPE_IDENT" +
                "ITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Salary] SET [EmployeeId] = @EmployeeId, [Salary] = @Salary WHERE (([SalaryId] = @Original_SalaryId) AND ([EmployeeId] = @Original_EmployeeId) AND ([Salary] = @Original_Salary));
SELECT SalaryId, EmployeeId, Salary FROM Salary WHERE (SalaryId = @SalaryId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT SalaryId, EmployeeId, Salary FROM dbo.Salary";
        ...
        public virtual int Fill(DBDataSet3.SalaryDataTable dataTable) {
        ...
        public virtual DBDataSet3.SalaryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DBDataSet3.SalaryDataTable dataTable = new DBDataSet3.SalaryDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DBDataSet3.SalaryDataTable dataTable) {
        ...
        public virtual int Delete(int Original_SalaryId, int Original_EmployeeId, decimal Original_Salary) {
        ...
        public virtual int Insert(int EmployeeId, decimal Salary) {
        ...
        public virtual int Update(int EmployeeId, decimal Salary, int Original_SalaryId, int Original_EmployeeId, decimal Original_Salary, int SalaryId) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(SalaryId));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int EmployeeId, decimal Salary, int Original_SalaryId, int Original_EmployeeId, decimal Original_Salary) {
            return this.Update(EmployeeId, Salary, Original_SalaryId, Original_EmployeeId, Original_Salary, Original_SalaryId);
        }
    }
